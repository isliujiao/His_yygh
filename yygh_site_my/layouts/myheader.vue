    ...
    <div class="wrapper">
      ...
      <div class="search-wrapper">
        <div class="hospital-search animation-show">
          <el-autocomplete class="search-input small" prefix-icon="el-icon-search" :fetch-suggestions="querySearchAsync"
...
export default {
  ...
  methods: {
    ...
    getCodeFun() {
      ...
      smsApi.sendEmailCode(this.userInfo.email).then(response => {
        this.timeDown();
      }).catch(e => {
