...
import com.atguigu.yygh.hosp.mapper.SceduleMapper;
 ...
 */
@Service
public class ScheduleServiceImpl extends ServiceImpl<SceduleMapper,Schedule> implements ScheduleService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        //根据 医院编号 and 排班编号 进行查询(获取查询出来的对象)
        Schedule scheduleExist = scheduleRepository.
                getScheduleByHoscodeAndHosScheduleId(schedule.getHoscode(), schedule.getHosScheduleId());

        //判断
        if (scheduleExist != null) {//有数据做 修改 操作
    ...
    public ScheduleOrderVo getScheduleOrderVo(String scheduleId) {
        ...
        scheduleOrderVo.setHosname(hospitalService.getHospName(schedule.getHoscode()));//名称
    ...
    private IPage getListDate(Integer page, Integer limit, BookingRule bookingRule) {
        ...
        //因为预约周期不同，每页显示日期最多显示7天数据，超过7天分页
